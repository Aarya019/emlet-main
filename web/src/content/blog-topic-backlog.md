...
Running list for the 1-2 posts/day cadence. Status per line: `queued`, `published (slug)`, or `skipped (why)`.
Not every post needs to mention Emlet, most shouldn't. Pull the next `queued` item when asked to "surprise me,"
or add new ones as they come up. Keep categories varied (email marketing, copywriting, design, small-business
