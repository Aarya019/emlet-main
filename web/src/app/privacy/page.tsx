...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Emlet, the AI email design generator.',
};
      ...
      <div className="space-y-10 text-white/70 leading-relaxed">
        ...
        <Section title="2. How We Use Your Information">
          ...
          <p className="mt-4">
            ...
            or generated content to train AI models, ours or our providers'.
          </p>
        </Section>

        <Section title="3. How We Share Your Information">
          <p>We share data only with the following categories of third parties, and only as necessary
          ...
          <ul className="mt-3 space-y-2 list-none">
            {[
              ...
              'Paddle — our merchant of record and payment processor; handles billing and subscription management',
              ...
              'Vercel — hosts the Service and provides aggregate analytics on site usage',
              'Google Analytics — provides aggregate analytics on how visitors use our website',
            ].map((item) => (
              <li key={item} className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#00ffff]/50 flex-shrink-0" />
                {item}
          ...
          <p className="mt-4">
            ...
            rights, property, or safety of Emlet, our users, or others, or in connection with a merger,
        ...
        <Section title="4. International Data Transfers">
          <p>
            Emlet is operated from India, and several of the providers listed above process data in
            the United States or other countries outside your own. Where we transfer personal data
            internationally, we rely on the transfer mechanisms and safeguards those providers offer
            (such as standard contractual clauses) to protect your data consistent with this policy.
          </p>
        </Section>
        ...
        <Section title="7. Your Rights">
          ...
          <p className="mt-4">
            ...
            information we collect and to request its deletion, as described above; we do not sell
            personal information as defined by the CCPA. If you are in the EU, UK, or a jurisdiction
            with similar law, you also have the right to lodge a complaint with your local data
        ...
        <Section title="11. Contact">
          <p>
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-[#00ffff] hover:underline">
              {CONTACT_EMAIL}
            </a>. This also serves as the contact for privacy inquiries under GDPR, CCPA, or similar law,
            since Emlet does not currently have a separate designated Data Protection Officer.
          </p>
        </Section>
