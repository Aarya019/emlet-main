        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.paddle.com https://sandbox-cdn.paddle.com https://public.profitwell.com https://vercel.live",
              ...
              "img-src 'self' data: blob: https://*.paddle.com https://*.supabase.co https://images.pexels.com https://i.ytimg.com https://*.gstatic.com https://*.googleusercontent.com https://api.iconify.design",
